package com.example.yemeksiparisiapp.entity;

import com.google.gson.annotations.Expose;
import com.google.gson.annotations.SerializedName;

import java.io.Serializable;
//serizable veri transferinde kullanıyoruz
public class Yemekler implements Serializable {
    ...
    public Yemekler(int sepet_yemek_id, String yemek_adi, String yemek_resim_adi, int yemek_fiyat, int yemek_siparis_adet, String kullanici_adi) {
